 ...
 <nav class="navbar navbar-expand fixed-top gradient-scooter">
  <ul class="navbar-nav mr-auto middle-nav-link">
    ...
    <li class="nav-item text-center">
        <a href="#" class="btn btn-dark btn-outline" style="color: #d2d6d8"><i class="ti-layout-accordion-list"></i> Invoice</a>

        <a href="#" class="btn btn-dark btn-outline" style="color: #d2d6d8""><i class="fa fa-money"></i> Receipt</a>

        <a href="#" class="btn btn-dark btn-outline" style="color: #d2d6d8""><i class="fa fa-paypal" aria-hidden="true"></i> Payment</a>

        <a href="#" class="btn btn-dark btn-outline" style="color: #d2d6d8""><i class="ti-shopping-cart"></i> Purchase</a>
    </li>
  </ul>
